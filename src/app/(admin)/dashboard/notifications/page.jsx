...
const INITIAL_NOTIFICATIONS = [
  ...
  { id: 2,  type: 'order',   priority: 'high',     title: 'New Order Received',            message: 'Order #ORD-2841 placed by Rahim Uddin for ৳1,250. 3 items. Payment via bKash — awaiting confirmation.', time: '5 min ago',  date: 'Today',     unread: true,  pinned: false, actions: [{ label: 'View Order', href: '/dashboard/orders' }] },
  { id: 3,  type: 'payment', priority: 'high',     title: 'Payment Failed',                message: 'Order #ORD-2838 payment via Nagad failed. Customer Karim Hossain may need to retry. Total: ৳720.', time: '12 min ago', date: 'Today',     unread: true,  pinned: false, actions: [{ label: 'View Order', href: '/dashboard/orders' }] },
  ...
  { id: 8,  type: 'payment', priority: 'low',      title: 'Daily Payment Summary',         message: 'Today\'s payment summary: ৳48,320 collected across 38 orders. bKash: 62%, Nagad: 24%, COD: 14%.', time: '3 hr ago',   date: 'Today',     unread: false, pinned: false, actions: [] },
  ...
  { id: 11, type: 'order',   priority: 'medium',   title: 'Bulk Order Alert',              message: 'Large order #ORD-2830 received — 12 items totalling ৳18,400 from a verified wholesale buyer.', time: 'Yesterday',  date: 'Yesterday', unread: false, pinned: false, actions: [{ label: 'View Order', href: '/dashboard/orders' }] },
  ...
  { id: 14, type: 'payment', priority: 'medium',   title: 'Refund Processed',              message: 'Refund of ৳3,800 processed for Order #ORD-2821 (Nusrat Jahan). Transaction ID: TXN-88421.', time: '3 days ago', date: 'Earlier',   unread: false, pinned: false, actions: [] },
