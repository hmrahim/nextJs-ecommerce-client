...
const PAYOUTS_SEED = [
  { id: 'PO-2026-00128', seller: SELLERS[0], grossAmount: 184520, commission: 18452, fees: 850, tax: 2767, netAmount: 162451, currency: 'SAR', method: 'bank',   account: 'DBBL ••4521', status: 'paid',       requestedAt: iso(now-12*day), processedAt: iso(now-10*day), orders: 142, period: 'Nov 16 – Nov 30, 2025', txnId: 'TXN-9281044', notes: '' },
  { id: 'PO-2026-00129', seller: SELLERS[1], grossAmount: 96400,  commission: 9640,  fees: 500, tax: 1446, netAmount: 84814,  currency: 'SAR', method: 'bkash',  account: '+8801712••3344', status: 'processing', requestedAt: iso(now-3*day),  processedAt: null,            orders: 78,  period: 'Dec 01 – Dec 15, 2025', txnId: '',          notes: 'Auto release on T+2' },
  { id: 'PO-2026-00130', seller: SELLERS[2], grossAmount: 312800, commission: 31280, fees: 1200,tax: 4692, netAmount: 275628, currency: 'SAR', method: 'bank',   account: 'BRAC ••8812', status: 'pending',    requestedAt: iso(now-1*day),  processedAt: null,            orders: 211, period: 'Dec 01 – Dec 15, 2025', txnId: '',          notes: '' },
  { id: 'PO-2026-00131', seller: SELLERS[3], grossAmount: 54200,  commission: 5420,  fees: 350, tax: 813,  netAmount: 47617,  currency: 'SAR', method: 'nagad',  account: '+8801812••9911', status: 'paid',       requestedAt: iso(now-22*day), processedAt: iso(now-20*day), orders: 41,  period: 'Nov 01 – Nov 15, 2025', txnId: 'TXN-9244112', notes: '' },
  { id: 'PO-2026-00132', seller: SELLERS[4], grossAmount: 128900, commission: 12890, fees: 700, tax: 1934, netAmount: 113376, currency: 'SAR', method: 'rocket', account: '+8801911••2233', status: 'failed',     requestedAt: iso(now-5*day),  processedAt: iso(now-4*day),  orders: 96,  period: 'Dec 01 – Dec 15, 2025', txnId: '',          notes: 'Account inactive — retry needed' },
  { id: 'PO-2026-00133', seller: SELLERS[5], grossAmount: 442100, commission: 44210, fees: 1800,tax: 6632, netAmount: 389458, currency: 'SAR', method: 'bank',   account: 'EBL ••1147',  status: 'on_hold',    requestedAt: iso(now-2*day),  processedAt: null,            orders: 318, period: 'Dec 01 – Dec 15, 2025', txnId: '',          notes: 'KYC verification pending' },
  { id: 'PO-2026-00134', seller: SELLERS[6], grossAmount: 76300,  commission: 7630,  fees: 400, tax: 1145, netAmount: 67125,  currency: 'SAR', method: 'bkash',  account: '+8801511••7788', status: 'paid',       requestedAt: iso(now-35*day), processedAt: iso(now-33*day), orders: 58,  period: 'Oct 16 – Oct 31, 2025', txnId: 'TXN-9112889', notes: '' },
  { id: 'PO-2026-00135', seller: SELLERS[7], grossAmount: 198400, commission: 19840, fees: 950, tax: 2976, netAmount: 174634, currency: 'SAR', method: 'bank',   account: 'CITY ••3320', status: 'processing', requestedAt: iso(now-4*day),  processedAt: null,            orders: 154, period: 'Dec 01 – Dec 15, 2025', txnId: '',          notes: '' },
  { id: 'PO-2026-00136', seller: SELLERS[0], grossAmount: 88100,  commission: 8810,  fees: 450, tax: 1322, netAmount: 77518,  currency: 'SAR', method: 'bkash',  account: '+8801711••5544', status: 'pending',    requestedAt: iso(now-1*day),  processedAt: null,            orders: 64,  period: 'Dec 01 – Dec 15, 2025', txnId: '',          notes: '' },
  { id: 'PO-2026-00137', seller: SELLERS[2], grossAmount: 256700, commission: 25670, fees: 1100,tax: 3851, netAmount: 226079, currency: 'SAR', method: 'bank',   account: 'BRAC ••8812', status: 'paid',       requestedAt: iso(now-45*day), processedAt: iso(now-43*day), orders: 188, period: 'Oct 16 – Oct 31, 2025', txnId: 'TXN-9018744', notes: '' },
  { id: 'PO-2026-00138', seller: SELLERS[3], grossAmount: 41200,  commission: 4120,  fees: 300, tax: 618,  netAmount: 36162,  currency: 'SAR', method: 'nagad',  account: '+8801812••9911', status: 'paid',       requestedAt: iso(now-50*day), processedAt: iso(now-48*day), orders: 32,  period: 'Oct 01 – Oct 15, 2025', txnId: 'TXN-8998441', notes: '' },
  { id: 'PO-2026-00139', seller: SELLERS[5], grossAmount: 521800, commission: 52180, fees: 2000,tax: 7827, netAmount: 459793, currency: 'SAR', method: 'bank',   account: 'EBL ••1147',  status: 'pending',    requestedAt: iso(now-1*day),  processedAt: null,            orders: 387, period: 'Dec 01 – Dec 15, 2025', txnId: '',          notes: 'Large amount — needs manager approval' },
];

const fmt = (n) => `SAR ${Number(n).toLocaleString('en-IN', { maximumFractionDigits: 0 })}`;
