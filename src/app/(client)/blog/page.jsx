...
const posts = [
  ...
  { id: "2", t: "How GreenMart Vendors Tripled Sales in 6 Months", c: "Seller Success", d: "Jun 4, 2026", img: "https://picsum.photos/seed/post2/800/500", e: "Real stories from 5 sellers who scaled with our marketplace tools." },
  ...
  { id: "4", t: "Behind the Scenes: A Day at Our Fulfillment Center", c: "Inside GreenMart", d: "May 22, 2026", img: "https://picsum.photos/seed/post4/800/500", e: "From order to doorstep \u2014 how we deliver 200,000 packages daily." },
...
function Blog() {
  ...
  return <div className="container-x py-10">
      <div className="text-center mb-10">
        <h1 className="font-display text-4xl font-bold">GreenMart Stories</h1>
        <p className="mt-2 text-muted-foreground">Insights, guides, and stories from our marketplace.</p>
      </div>
      <div className="mb-6 flex flex-wrap gap-2">
        {["All", "Sustainability", "Buying Guides", "Seller Success", "Fashion", "Tech", "Inside GreenMart"].map((c, i) => <button key={c} className={`rounded-full px-4 py-2 text-sm font-semibold ${i === 0 ? "bg-emerald-600 text-white" : "bg-emerald-50 text-emerald-700 hover:bg-emerald-100"}`}>{c}</button>)}
      </div>
