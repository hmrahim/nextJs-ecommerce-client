  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 gap-8">
      <div className="space-y-4">
        ...
        {[['firstName','First Name'],['lastName','Last Name'],['email','Email'],['phone','Phone'],['address','Address'],['city','City'],['postalCode','Postal Code']].map(([field, label]) => (
          <div key={field}>
            ...
            <input {...register(field)} className="w-full border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900" />
      ...
      <div>
        ...
        <div className="border border-border rounded-xl p-4 text-gray-400 text-sm mb-4">Stripe / payment gateway here</div>
